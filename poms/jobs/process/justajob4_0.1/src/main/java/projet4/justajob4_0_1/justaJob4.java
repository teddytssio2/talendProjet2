...
/**
 * Job: justaJob4 Purpose: <br>
 * Description:  <br>
 * @author teddy.lequette@hardis.fr
 * @version 7.0.1.20180903_1027-patch
 * @status 
 */
public class justaJob4 implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "justaJob4.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger
			.getLogger(justaJob4.class);
	...
	private final String jobName = "justaJob4";
	private final String projectName = "PROJET4";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(justaJob4.this, new Object[] { e,
	...
	public static void main(String[] args) {
		final justaJob4 justaJob4Class = new justaJob4();

		int exitCode = justaJob4Class.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'justaJob4' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'justaJob4' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = justaJob4.class.getClassLoader()
					.getResourceAsStream(
							"projet4/justajob4_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = justaJob4.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : justaJob4");
		}
...
/************************************************************************************************
 * 25858 characters generated by Talend Cloud Data Management Platform on the 14
 * novembre 2018 16:11:59 CET
 ************************************************************************************************/
